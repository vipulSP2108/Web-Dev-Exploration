            ...
            className=' relative h-[260px] w-[205px] rounded-3xl overflow-hidden px-4 py-5 text-white bg-zinc-900/90 '>
                ...
                <div className="footer absolute bottom-0 w-full left-0">
                    ...
                    <div className=" px-5 flex justify-between items-center mb-5">
                        <h5 className= {`text-sm ${ porps.data.download_option == true ? "text-green-500" : "text-blue-600"} font-semibold`}>{porps.data.data_size}</h5>
                        {porps.data.download_option == true ? 
                            (<span className=" px-1 py-1 bg-white text-zinc-900 rounded-full ">
                    ...
                    {porps.data.download_option == true ? <div className=" w-full h-10 bg-green-500 bottom-0 flex justify-center font-semibold items-center text-zinc-950"> Download Now! </div>
...
//             const element = <MdOutlineFileDownload />;
//             ReactDOM.render(element, document.getElementById("span_download_icon"));
//             document.getElementById("span_download_option").style.backgroundColor = 'rgb(34 197 94)';
//             document.getElementById("span_download_option").innerHTML = ' Download Now! ';
...
//                     <div className=" px-5 flex justify-between items-center mb-5">
//                         <h5 id="download_size" className= {"text-sm text-green-500 font-semibold"}>{porps.data.data_size}</h5> 
//                         <div id="span_download_icon" onClick={download_started} className=" px-2 py-2 rounded-full bg-white text-zinc-900">
//                         <MdOutlineFileDownload /></div>
//                     </div>
//                     <div onClick={download_started} id="span_download_option" className=" w-full h-10 bg-green-500 bottom-0 flex justify-center font-semibold items-center text-zinc-950"> Download Now! </div>
//                 </div>
